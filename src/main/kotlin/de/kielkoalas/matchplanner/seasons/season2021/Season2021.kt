package de.kielkoalas.matchplanner.seasons.season2021

import de.kielkoalas.matchplanner.Dictionary
import de.kielkoalas.matchplanner.Solver
...
val HD = Club("HD", "Hamburg Dockers", setOf("m"))
val BC = Club("BC", "Berlin Crocodiles", setOf("m"))
...
fun main() {
    ...
    val problem = Problem(
        startDate = LocalDate.parse("2021-08-07"),
//        clubs = setOf(KK, HD, BC, RL, FR, HK, ZG, MK, DW),
        clubs = setOf(RL, FR, HK, ZG, MK),
//        clubs = setOf(KK, HD, BC, DW),
        distances = distances,
